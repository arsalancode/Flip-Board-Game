package com.eimy.flipboard.ddsdialog
...
import com.eimy.flipboard.core.FullScreenDialogFragment
import com.eimy.flipboard.ddsdialog.databinding.DdsDialogFragmentBinding
import kotlinx.android.synthetic.main.dds_dialog_fragment.*


class DDSDialog : FullScreenDialogFragment() {

    companion object {
        fun newInstance() = DDSDialog()

        // Useful dialog instance that will be used throughout the app down here:
    }
    ...
    private var negativeButtonClicked: ((dialog: DDSDialog, button: TextView) -> Unit)? = null

    private var positiveButtonClicked: ((dialog: DDSDialog, button: TextView) -> Unit)? = null
    ...
    ): View? = DdsDialogFragmentBinding.inflate(
        inflater,
        container,
        false
    ...
    fun setImageRes(@DrawableRes imageRes: Int?): DDSDialog {
    ...
    fun setTitleRes(@StringRes titleRes: Int?): DDSDialog {
    ...
    fun setTextRes(@StringRes textRes: Int?): DDSDialog {
    ...
    fun setText(text: String?): DDSDialog {
        this.text = text
        if (!isDetached && isAdded) {
            vm.setText(text)
        }
    ...
    fun setLottieImage(@RawRes lottieRes: Int?): DDSDialog {
    ...
    fun setPositiveButton(
        ...
        clickCallback: (dialog: DDSDialog, button: TextView) -> Unit
    ): DDSDialog {
    ...
    fun setNegativeButton(
        @StringRes buttonTextRes: Int?,
        clickCallback: ((dialog: DDSDialog, button: TextView) -> Unit)? = null
    ): DDSDialog {
